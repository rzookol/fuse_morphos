...
settings_info settings_default = {
  ...
  /* competition_code */ 0,
  /* competition_mode */ 0,
  /* composite_filter_artifacts */ -59,
  /* composite_filter_bleed */ -71,
  /* composite_filter_brightness */ 10,
  /* composite_filter_contrast */ 21,
  /* composite_filter_fringing */ 14,
  /* composite_filter_gamma */ 0,
  /* composite_filter_hue */ 0,
  /* composite_filter_resolution */ -16,
  /* composite_filter_saturation */ -27,
  /* composite_filter_sharpness */ -10,
  /* confirm_actions */ 1,
  /* covox */ 0,
  /* dck_file */ (char *)NULL,
  ...
  /* rom_sp0256 */ (char *)"sp0256-al2.rom",
...
parse_xml( xmlDocPtr doc, settings_info *settings )
{
  ...
  while( node ) {
    ...
    if( !strcmp( (const char*)node->name, "compositefilterartifacts" ) ) {
      xmlstring = xmlNodeListGetString( doc, node->xmlChildrenNode, 1 );
      if( xmlstring ) {
        settings->composite_filter_artifacts = atoi( (char*)xmlstring );
        xmlFree( xmlstring );
      }
    } else
    if( !strcmp( (const char*)node->name, "compositefilterbleed" ) ) {
      xmlstring = xmlNodeListGetString( doc, node->xmlChildrenNode, 1 );
      if( xmlstring ) {
        settings->composite_filter_bleed = atoi( (char*)xmlstring );
        xmlFree( xmlstring );
      }
    } else
    if( !strcmp( (const char*)node->name, "compositefilterbrightness" ) ) {
      xmlstring = xmlNodeListGetString( doc, node->xmlChildrenNode, 1 );
      if( xmlstring ) {
        settings->composite_filter_brightness = atoi( (char*)xmlstring );
        xmlFree( xmlstring );
      }
    } else
    if( !strcmp( (const char*)node->name, "compositefiltercontrast" ) ) {
      xmlstring = xmlNodeListGetString( doc, node->xmlChildrenNode, 1 );
      if( xmlstring ) {
        settings->composite_filter_contrast = atoi( (char*)xmlstring );
        xmlFree( xmlstring );
      }
    } else
    if( !strcmp( (const char*)node->name, "compositefilterfringing" ) ) {
      xmlstring = xmlNodeListGetString( doc, node->xmlChildrenNode, 1 );
      if( xmlstring ) {
        settings->composite_filter_fringing = atoi( (char*)xmlstring );
        xmlFree( xmlstring );
      }
    } else
    if( !strcmp( (const char*)node->name, "compositefiltergamma" ) ) {
      xmlstring = xmlNodeListGetString( doc, node->xmlChildrenNode, 1 );
      if( xmlstring ) {
        settings->composite_filter_gamma = atoi( (char*)xmlstring );
        xmlFree( xmlstring );
      }
    } else
    if( !strcmp( (const char*)node->name, "compositefilterhue" ) ) {
      xmlstring = xmlNodeListGetString( doc, node->xmlChildrenNode, 1 );
      if( xmlstring ) {
        settings->composite_filter_hue = atoi( (char*)xmlstring );
        xmlFree( xmlstring );
      }
    } else
    if( !strcmp( (const char*)node->name, "compositefilterresolution" ) ) {
      xmlstring = xmlNodeListGetString( doc, node->xmlChildrenNode, 1 );
      if( xmlstring ) {
        settings->composite_filter_resolution = atoi( (char*)xmlstring );
        xmlFree( xmlstring );
      }
    } else
    if( !strcmp( (const char*)node->name, "compositefiltersaturation" ) ) {
      xmlstring = xmlNodeListGetString( doc, node->xmlChildrenNode, 1 );
      if( xmlstring ) {
        settings->composite_filter_saturation = atoi( (char*)xmlstring );
        xmlFree( xmlstring );
      }
    } else
    if( !strcmp( (const char*)node->name, "compositefiltersharpness" ) ) {
      xmlstring = xmlNodeListGetString( doc, node->xmlChildrenNode, 1 );
      if( xmlstring ) {
        settings->composite_filter_sharpness = atoi( (char*)xmlstring );
        xmlFree( xmlstring );
      }
    } else
...
settings_write_config( settings_info *settings )
{
  ...
  snprintf( buffer, 80, "%d", settings->composite_filter_artifacts );
  xmlNewTextChild( root, NULL, (const xmlChar*)"compositefilterartifacts", (const xmlChar*)buffer );
  snprintf( buffer, 80, "%d", settings->composite_filter_bleed );
  xmlNewTextChild( root, NULL, (const xmlChar*)"compositefilterbleed", (const xmlChar*)buffer );
  snprintf( buffer, 80, "%d", settings->composite_filter_brightness );
  xmlNewTextChild( root, NULL, (const xmlChar*)"compositefilterbrightness", (const xmlChar*)buffer );
  snprintf( buffer, 80, "%d", settings->composite_filter_contrast );
  xmlNewTextChild( root, NULL, (const xmlChar*)"compositefiltercontrast", (const xmlChar*)buffer );
  snprintf( buffer, 80, "%d", settings->composite_filter_fringing );
  xmlNewTextChild( root, NULL, (const xmlChar*)"compositefilterfringing", (const xmlChar*)buffer );
  snprintf( buffer, 80, "%d", settings->composite_filter_gamma );
  xmlNewTextChild( root, NULL, (const xmlChar*)"compositefiltergamma", (const xmlChar*)buffer );
  snprintf( buffer, 80, "%d", settings->composite_filter_hue );
  xmlNewTextChild( root, NULL, (const xmlChar*)"compositefilterhue", (const xmlChar*)buffer );
  snprintf( buffer, 80, "%d", settings->composite_filter_resolution );
  xmlNewTextChild( root, NULL, (const xmlChar*)"compositefilterresolution", (const xmlChar*)buffer );
  snprintf( buffer, 80, "%d", settings->composite_filter_saturation );
  xmlNewTextChild( root, NULL, (const xmlChar*)"compositefiltersaturation", (const xmlChar*)buffer );
  snprintf( buffer, 80, "%d", settings->composite_filter_sharpness );
  xmlNewTextChild( root, NULL, (const xmlChar*)"compositefiltersharpness", (const xmlChar*)buffer );
...
/*  ui_error( UI_ERROR_WARNING, "Config: (%5s): ", name ); */
  ...
  if( n == 24 && !strncmp( (const char *)name, "compositefilterartifacts", n ) ) {
    *val_int = &settings->composite_filter_artifacts;
    return 0;
  }
  if( n == 20 && !strncmp( (const char *)name, "compositefilterbleed", n ) ) {
    *val_int = &settings->composite_filter_bleed;
    return 0;
  }
  if( n == 25 && !strncmp( (const char *)name, "compositefilterbrightness", n ) ) {
    *val_int = &settings->composite_filter_brightness;
    return 0;
  }
  if( n == 23 && !strncmp( (const char *)name, "compositefiltercontrast", n ) ) {
    *val_int = &settings->composite_filter_contrast;
    return 0;
  }
  if( n == 23 && !strncmp( (const char *)name, "compositefilterfringing", n ) ) {
    *val_int = &settings->composite_filter_fringing;
    return 0;
  }
  if( n == 20 && !strncmp( (const char *)name, "compositefiltergamma", n ) ) {
    *val_int = &settings->composite_filter_gamma;
    return 0;
  }
  if( n == 18 && !strncmp( (const char *)name, "compositefilterhue", n ) ) {
    *val_int = &settings->composite_filter_hue;
    return 0;
  }
  if( n == 25 && !strncmp( (const char *)name, "compositefilterresolution", n ) ) {
    *val_int = &settings->composite_filter_resolution;
    return 0;
  }
  if( n == 25 && !strncmp( (const char *)name, "compositefiltersaturation", n ) ) {
    *val_int = &settings->composite_filter_saturation;
    return 0;
  }
  if( n == 24 && !strncmp( (const char *)name, "compositefiltersharpness", n ) ) {
    *val_int = &settings->composite_filter_sharpness;
    return 0;
  }
...
settings_write_config( settings_info *settings )
{
  ...
  if( settings_boolean_write( doc, "competitionmode",
    ...
    goto error;
  if( settings_numeric_write( doc, "compositefilterartifacts",
                              settings->composite_filter_artifacts ) )
    goto error;
  if( settings_numeric_write( doc, "compositefilterbleed",
                              settings->composite_filter_bleed ) )
    goto error;
  if( settings_numeric_write( doc, "compositefilterbrightness",
                              settings->composite_filter_brightness ) )
    goto error;
  if( settings_numeric_write( doc, "compositefiltercontrast",
                              settings->composite_filter_contrast ) )
    goto error;
  if( settings_numeric_write( doc, "compositefilterfringing",
                              settings->composite_filter_fringing ) )
    goto error;
  if( settings_numeric_write( doc, "compositefiltergamma",
                              settings->composite_filter_gamma ) )
    goto error;
  if( settings_numeric_write( doc, "compositefilterhue",
                              settings->composite_filter_hue ) )
    goto error;
  if( settings_numeric_write( doc, "compositefilterresolution",
                              settings->composite_filter_resolution ) )
    goto error;
  if( settings_numeric_write( doc, "compositefiltersaturation",
                              settings->composite_filter_saturation ) )
    goto error;
  if( settings_numeric_write( doc, "compositefiltersharpness",
                              settings->composite_filter_sharpness ) )
    goto error;
                       ...
                       int argc, char **argv )
{
  ...
  struct option long_options[] = {
    ...
    { "composite-filter-artifacts", 1, NULL, 258 },
    { "composite-filter-bleed", 1, NULL, 259 },
    { "composite-filter-brightness", 1, NULL, 260 },
    { "composite-filter-contrast", 1, NULL, 261 },
    { "composite-filter-fringing", 1, NULL, 262 },
    { "composite-filter-gamma", 1, NULL, 263 },
    { "composite-filter-hue", 1, NULL, 264 },
    { "composite-filter-resolution", 1, NULL, 265 },
    { "composite-filter-saturation", 1, NULL, 266 },
    { "composite-filter-sharpness", 1, NULL, 267 },
    ...
    { "divmmc-file", 1, NULL, 275 },
    {    "divmmc-write-protect", 0, &(settings->divmmc_wp), 1 },
    { "no-divmmc-write-protect", 0, &(settings->divmmc_wp), 0 },
    { "doublescan-mode", 1, NULL, 'D' },
    { "drive-40-max-track", 1, NULL, 277 },
    { "drive-80-max-track", 1, NULL, 278 },
    { "drive-beta128a-type", 1, NULL, 279 },
    { "drive-beta128b-type", 1, NULL, 280 },
    { "drive-beta128c-type", 1, NULL, 281 },
    { "drive-beta128d-type", 1, NULL, 282 },
    { "drive-didaktik80a-type", 1, NULL, 283 },
    { "drive-didaktik80b-type", 1, NULL, 284 },
    { "drive-disciple1-type", 1, NULL, 285 },
    { "drive-disciple2-type", 1, NULL, 286 },
    { "drive-opus1-type", 1, NULL, 287 },
    { "drive-opus2-type", 1, NULL, 288 },
    { "drive-plus3a-type", 1, NULL, 289 },
    { "drive-plus3b-type", 1, NULL, 290 },
    { "drive-plusd1-type", 1, NULL, 291 },
    { "drive-plusd2-type", 1, NULL, 292 },
    ...
    { "joystick-1-fire-1", 1, NULL, 296 },
    { "joystick-1-fire-10", 1, NULL, 297 },
    { "joystick-1-fire-11", 1, NULL, 298 },
    { "joystick-1-fire-12", 1, NULL, 299 },
    { "joystick-1-fire-13", 1, NULL, 300 },
    { "joystick-1-fire-14", 1, NULL, 301 },
    { "joystick-1-fire-15", 1, NULL, 302 },
    { "joystick-1-fire-2", 1, NULL, 303 },
    { "joystick-1-fire-3", 1, NULL, 304 },
    { "joystick-1-fire-4", 1, NULL, 305 },
    { "joystick-1-fire-5", 1, NULL, 306 },
    { "joystick-1-fire-6", 1, NULL, 307 },
    { "joystick-1-fire-7", 1, NULL, 308 },
    { "joystick-1-fire-8", 1, NULL, 309 },
    { "joystick-1-fire-9", 1, NULL, 310 },
    { "joystick-1-output", 1, NULL, 311 },
    { "joystick-2-fire-1", 1, NULL, 312 },
    { "joystick-2-fire-10", 1, NULL, 313 },
    { "joystick-2-fire-11", 1, NULL, 314 },
    { "joystick-2-fire-12", 1, NULL, 315 },
    { "joystick-2-fire-13", 1, NULL, 316 },
    { "joystick-2-fire-14", 1, NULL, 317 },
    { "joystick-2-fire-15", 1, NULL, 318 },
    { "joystick-2-fire-2", 1, NULL, 319 },
    { "joystick-2-fire-3", 1, NULL, 320 },
    { "joystick-2-fire-4", 1, NULL, 321 },
    { "joystick-2-fire-5", 1, NULL, 322 },
    { "joystick-2-fire-6", 1, NULL, 323 },
    { "joystick-2-fire-7", 1, NULL, 324 },
    { "joystick-2-fire-8", 1, NULL, 325 },
    { "joystick-2-fire-9", 1, NULL, 326 },
    { "joystick-2-output", 1, NULL, 327 },
    { "joystick-keyboard-down", 1, NULL, 328 },
    { "joystick-keyboard-fire", 1, NULL, 329 },
    { "joystick-keyboard-left", 1, NULL, 330 },
    { "joystick-keyboard-output", 1, NULL, 331 },
    { "joystick-keyboard-right", 1, NULL, 332 },
    { "joystick-keyboard-up", 1, NULL, 333 },
    ...
    { "microdrive-file", 1, NULL, 334 },
    { "microdrive-2-file", 1, NULL, 335 },
    { "microdrive-3-file", 1, NULL, 336 },
    { "microdrive-4-file", 1, NULL, 337 },
    { "microdrive-5-file", 1, NULL, 338 },
    { "microdrive-6-file", 1, NULL, 339 },
    { "microdrive-7-file", 1, NULL, 340 },
    { "microdrive-8-file", 1, NULL, 341 },
    { "mdr-len", 1, NULL, 342 },
    ...
    { "movie-compr", 1, NULL, 343 },
    { "movie-start", 1, NULL, 344 },
    ...
    { "rom-128-0", 1, NULL, 353 },
    { "rom-128-1", 1, NULL, 354 },
    { "rom-16", 1, NULL, 355 },
    { "rom-48", 1, NULL, 356 },
    { "rom-beta128", 1, NULL, 357 },
    { "rom-didaktik80", 1, NULL, 358 },
    { "rom-disciple", 1, NULL, 359 },
    { "rom-interface-1", 1, NULL, 360 },
    { "rom-multiface1", 1, NULL, 361 },
    { "rom-multiface128", 1, NULL, 362 },
    { "rom-multiface3", 1, NULL, 363 },
    { "rom-opus", 1, NULL, 364 },
    { "rom-pentagon1024-0", 1, NULL, 365 },
    { "rom-pentagon1024-1", 1, NULL, 366 },
    { "rom-pentagon1024-2", 1, NULL, 367 },
    { "rom-pentagon1024-3", 1, NULL, 368 },
    { "rom-pentagon512-0", 1, NULL, 369 },
    { "rom-pentagon512-1", 1, NULL, 370 },
    { "rom-pentagon512-2", 1, NULL, 371 },
    { "rom-pentagon512-3", 1, NULL, 372 },
    { "rom-pentagon-0", 1, NULL, 373 },
    { "rom-pentagon-1", 1, NULL, 374 },
    { "rom-pentagon-2", 1, NULL, 375 },
    { "rom-plus2-0", 1, NULL, 376 },
    { "rom-plus2-1", 1, NULL, 377 },
    { "rom-plus2a-0", 1, NULL, 378 },
    { "rom-plus2a-1", 1, NULL, 379 },
    { "rom-plus2a-2", 1, NULL, 380 },
    { "rom-plus2a-3", 1, NULL, 381 },
    { "rom-plus3-0", 1, NULL, 382 },
    { "rom-plus3-1", 1, NULL, 383 },
    { "rom-plus3-2", 1, NULL, 384 },
    { "rom-plus3-3", 1, NULL, 385 },
    { "rom-plus3e-0", 1, NULL, 386 },
    { "rom-plus3e-1", 1, NULL, 387 },
    { "rom-plus3e-2", 1, NULL, 388 },
    { "rom-plus3e-3", 1, NULL, 389 },
    { "rom-plusd", 1, NULL, 390 },
    { "rom-scorpion-0", 1, NULL, 391 },
    { "rom-scorpion-1", 1, NULL, 392 },
    { "rom-scorpion-2", 1, NULL, 393 },
    { "rom-scorpion-3", 1, NULL, 394 },
    { "rom-sp0256", 1, NULL, 395 },
    { "rom-spec-se-0", 1, NULL, 396 },
    { "rom-spec-se-1", 1, NULL, 397 },
    { "rom-speccyboot", 1, NULL, 398 },
    { "rom-tc2048", 1, NULL, 399 },
    { "rom-tc2068-0", 1, NULL, 400 },
    { "rom-tc2068-1", 1, NULL, 401 },
    { "rom-ts2068-0", 1, NULL, 402 },
    { "rom-ts2068-1", 1, NULL, 403 },
    { "rom-ttx2000s", 1, NULL, 404 },
    { "rom-usource", 1, NULL, 405 },
    { "rom-uspeech", 1, NULL, 406 },
    ...
    { "sdl-fullscreen-mode", 1, NULL, 409 },
    {    "simpleide", 0, &(settings->simpleide_active), 1 },
    { "no-simpleide", 0, &(settings->simpleide_active), 0 },
    { "simpleide-masterfile", 1, NULL, 410 },
    { "simpleide-slavefile", 1, NULL, 411 },
    ...
    { "separation", 1, NULL, 416 },
    { "tape", 1, NULL, 't' },
    {    "traps", 0, &(settings->tape_traps), 1 },
    { "no-traps", 0, &(settings->tape_traps), 0 },
    { "teletext-addr-1", 1, NULL, 418 },
    { "teletext-addr-2", 1, NULL, 419 },
    { "teletext-addr-3", 1, NULL, 420 },
    { "teletext-addr-4", 1, NULL, 421 },
    { "teletext-port-1", 1, NULL, 422 },
    { "teletext-port-2", 1, NULL, 423 },
    { "teletext-port-3", 1, NULL, 424 },
    { "teletext-port-4", 1, NULL, 425 },
    ...
    { "volume-ay", 1, NULL, 426 },
    { "volume-beeper", 1, NULL, 427 },
    { "volume-covox", 1, NULL, 428 },
    { "volume-specdrum", 1, NULL, 429 },
    { "volume-uspeech", 1, NULL, 430 },
    ...
    { "zxatasp-masterfile", 1, NULL, 431 },
    { "zxatasp-slavefile", 1, NULL, 432 },
...
#line 636"./settings.pl"
  ...
  while( 1 ) {
    ...
    case 258: settings->composite_filter_artifacts = atoi( optarg ); break;
    case 259: settings->composite_filter_bleed = atoi( optarg ); break;
    case 260: settings->composite_filter_brightness = atoi( optarg ); break;
    case 261: settings->composite_filter_contrast = atoi( optarg ); break;
    case 262: settings->composite_filter_fringing = atoi( optarg ); break;
    case 263: settings->composite_filter_gamma = atoi( optarg ); break;
    case 264: settings->composite_filter_hue = atoi( optarg ); break;
    case 265: settings->composite_filter_resolution = atoi( optarg ); break;
    case 266: settings->composite_filter_saturation = atoi( optarg ); break;
    case 267: settings->composite_filter_sharpness = atoi( optarg ); break;
    case 268: settings_set_string( &settings->dck_file, optarg ); break;
    case 269: settings_set_string( &settings->debugger_command, optarg ); break;
    case 270: settings_set_string( &settings->didaktik80disk_file, optarg ); break;
    case 271: settings_set_string( &settings->discipledisk_file, optarg ); break;
    case 272: settings_set_string( &settings->disk_try_merge, optarg ); break;
    case 273: settings_set_string( &settings->divide_master_file, optarg ); break;
    case 274: settings_set_string( &settings->divide_slave_file, optarg ); break;
    case 275: settings_set_string( &settings->divmmc_file, optarg ); break;
    case 'D': settings->doublescan_mode = atoi( optarg ); break;
    case 277: settings->drive_40_max_track = atoi( optarg ); break;
    case 278: settings->drive_80_max_track = atoi( optarg ); break;
    case 279: settings_set_string( &settings->drive_beta128a_type, optarg ); break;
    case 280: settings_set_string( &settings->drive_beta128b_type, optarg ); break;
    case 281: settings_set_string( &settings->drive_beta128c_type, optarg ); break;
    case 282: settings_set_string( &settings->drive_beta128d_type, optarg ); break;
    case 283: settings_set_string( &settings->drive_didaktik80a_type, optarg ); break;
    case 284: settings_set_string( &settings->drive_didaktik80b_type, optarg ); break;
    case 285: settings_set_string( &settings->drive_disciple1_type, optarg ); break;
    case 286: settings_set_string( &settings->drive_disciple2_type, optarg ); break;
    case 287: settings_set_string( &settings->drive_opus1_type, optarg ); break;
    case 288: settings_set_string( &settings->drive_opus2_type, optarg ); break;
    case 289: settings_set_string( &settings->drive_plus3a_type, optarg ); break;
    case 290: settings_set_string( &settings->drive_plus3b_type, optarg ); break;
    case 291: settings_set_string( &settings->drive_plusd1_type, optarg ); break;
    case 292: settings_set_string( &settings->drive_plusd2_type, optarg ); break;
    case 293: settings->emulation_speed = atoi( optarg ); break;
    case 'v': settings->fb_mode = atoi( optarg ); break;
    case 294: settings->frame_rate = atoi( optarg ); break;
    case 295: settings_set_string( &settings->if2_file, optarg ); break;
    case 296: settings->joystick_1_fire_1 = atoi( optarg ); break;
    case 297: settings->joystick_1_fire_10 = atoi( optarg ); break;
    case 298: settings->joystick_1_fire_11 = atoi( optarg ); break;
    case 299: settings->joystick_1_fire_12 = atoi( optarg ); break;
    case 300: settings->joystick_1_fire_13 = atoi( optarg ); break;
    case 301: settings->joystick_1_fire_14 = atoi( optarg ); break;
    case 302: settings->joystick_1_fire_15 = atoi( optarg ); break;
    case 303: settings->joystick_1_fire_2 = atoi( optarg ); break;
    case 304: settings->joystick_1_fire_3 = atoi( optarg ); break;
    case 305: settings->joystick_1_fire_4 = atoi( optarg ); break;
    case 306: settings->joystick_1_fire_5 = atoi( optarg ); break;
    case 307: settings->joystick_1_fire_6 = atoi( optarg ); break;
    case 308: settings->joystick_1_fire_7 = atoi( optarg ); break;
    case 309: settings->joystick_1_fire_8 = atoi( optarg ); break;
    case 310: settings->joystick_1_fire_9 = atoi( optarg ); break;
    case 311: settings->joystick_1_output = atoi( optarg ); break;
    case 312: settings->joystick_2_fire_1 = atoi( optarg ); break;
    case 313: settings->joystick_2_fire_10 = atoi( optarg ); break;
    case 314: settings->joystick_2_fire_11 = atoi( optarg ); break;
    case 315: settings->joystick_2_fire_12 = atoi( optarg ); break;
    case 316: settings->joystick_2_fire_13 = atoi( optarg ); break;
    case 317: settings->joystick_2_fire_14 = atoi( optarg ); break;
    case 318: settings->joystick_2_fire_15 = atoi( optarg ); break;
    case 319: settings->joystick_2_fire_2 = atoi( optarg ); break;
    case 320: settings->joystick_2_fire_3 = atoi( optarg ); break;
    case 321: settings->joystick_2_fire_4 = atoi( optarg ); break;
    case 322: settings->joystick_2_fire_5 = atoi( optarg ); break;
    case 323: settings->joystick_2_fire_6 = atoi( optarg ); break;
    case 324: settings->joystick_2_fire_7 = atoi( optarg ); break;
    case 325: settings->joystick_2_fire_8 = atoi( optarg ); break;
    case 326: settings->joystick_2_fire_9 = atoi( optarg ); break;
    case 327: settings->joystick_2_output = atoi( optarg ); break;
    case 328: settings->joystick_keyboard_down = atoi( optarg ); break;
    case 329: settings->joystick_keyboard_fire = atoi( optarg ); break;
    case 330: settings->joystick_keyboard_left = atoi( optarg ); break;
    case 331: settings->joystick_keyboard_output = atoi( optarg ); break;
    case 332: settings->joystick_keyboard_right = atoi( optarg ); break;
    case 333: settings->joystick_keyboard_up = atoi( optarg ); break;
    case 334: settings_set_string( &settings->mdr_file, optarg ); break;
    case 335: settings_set_string( &settings->mdr_file2, optarg ); break;
    case 336: settings_set_string( &settings->mdr_file3, optarg ); break;
    case 337: settings_set_string( &settings->mdr_file4, optarg ); break;
    case 338: settings_set_string( &settings->mdr_file5, optarg ); break;
    case 339: settings_set_string( &settings->mdr_file6, optarg ); break;
    case 340: settings_set_string( &settings->mdr_file7, optarg ); break;
    case 341: settings_set_string( &settings->mdr_file8, optarg ); break;
    case 342: settings->mdr_len = atoi( optarg ); break;
    case 343: settings_set_string( &settings->movie_compr, optarg ); break;
    case 344: settings_set_string( &settings->movie_start, optarg ); break;
    case 345: settings_set_string( &settings->opusdisk_file, optarg ); break;
    case 347: settings_set_string( &settings->phantom_typist_mode, optarg ); break;
    case 'p': settings_set_string( &settings->playback_file, optarg ); break;
    case 348: settings_set_string( &settings->plus3disk_file, optarg ); break;
    case 349: settings_set_string( &settings->plusddisk_file, optarg ); break;
    case 350: settings_set_string( &settings->printer_graphics_filename, optarg ); break;
    case 351: settings_set_string( &settings->printer_text_filename, optarg ); break;
    case 'r': settings_set_string( &settings->record_file, optarg ); break;
    case 353: settings_set_string( &settings->rom_128_0, optarg ); break;
    case 354: settings_set_string( &settings->rom_128_1, optarg ); break;
    case 355: settings_set_string( &settings->rom_16, optarg ); break;
    case 356: settings_set_string( &settings->rom_48, optarg ); break;
    case 357: settings_set_string( &settings->rom_beta128, optarg ); break;
    case 358: settings_set_string( &settings->rom_didaktik80, optarg ); break;
    case 359: settings_set_string( &settings->rom_disciple, optarg ); break;
    case 360: settings_set_string( &settings->rom_interface_1, optarg ); break;
    case 361: settings_set_string( &settings->rom_multiface1, optarg ); break;
    case 362: settings_set_string( &settings->rom_multiface128, optarg ); break;
    case 363: settings_set_string( &settings->rom_multiface3, optarg ); break;
    case 364: settings_set_string( &settings->rom_opus, optarg ); break;
    case 365: settings_set_string( &settings->rom_pentagon1024_0, optarg ); break;
    case 366: settings_set_string( &settings->rom_pentagon1024_1, optarg ); break;
    case 367: settings_set_string( &settings->rom_pentagon1024_2, optarg ); break;
    case 368: settings_set_string( &settings->rom_pentagon1024_3, optarg ); break;
    case 369: settings_set_string( &settings->rom_pentagon512_0, optarg ); break;
    case 370: settings_set_string( &settings->rom_pentagon512_1, optarg ); break;
    case 371: settings_set_string( &settings->rom_pentagon512_2, optarg ); break;
    case 372: settings_set_string( &settings->rom_pentagon512_3, optarg ); break;
    case 373: settings_set_string( &settings->rom_pentagon_0, optarg ); break;
    case 374: settings_set_string( &settings->rom_pentagon_1, optarg ); break;
    case 375: settings_set_string( &settings->rom_pentagon_2, optarg ); break;
    case 376: settings_set_string( &settings->rom_plus2_0, optarg ); break;
    case 377: settings_set_string( &settings->rom_plus2_1, optarg ); break;
    case 378: settings_set_string( &settings->rom_plus2a_0, optarg ); break;
    case 379: settings_set_string( &settings->rom_plus2a_1, optarg ); break;
    case 380: settings_set_string( &settings->rom_plus2a_2, optarg ); break;
    case 381: settings_set_string( &settings->rom_plus2a_3, optarg ); break;
    case 382: settings_set_string( &settings->rom_plus3_0, optarg ); break;
    case 383: settings_set_string( &settings->rom_plus3_1, optarg ); break;
    case 384: settings_set_string( &settings->rom_plus3_2, optarg ); break;
    case 385: settings_set_string( &settings->rom_plus3_3, optarg ); break;
    case 386: settings_set_string( &settings->rom_plus3e_0, optarg ); break;
    case 387: settings_set_string( &settings->rom_plus3e_1, optarg ); break;
    case 388: settings_set_string( &settings->rom_plus3e_2, optarg ); break;
    case 389: settings_set_string( &settings->rom_plus3e_3, optarg ); break;
    case 390: settings_set_string( &settings->rom_plusd, optarg ); break;
    case 391: settings_set_string( &settings->rom_scorpion_0, optarg ); break;
    case 392: settings_set_string( &settings->rom_scorpion_1, optarg ); break;
    case 393: settings_set_string( &settings->rom_scorpion_2, optarg ); break;
    case 394: settings_set_string( &settings->rom_scorpion_3, optarg ); break;
    case 395: settings_set_string( &settings->rom_sp0256, optarg ); break;
    case 396: settings_set_string( &settings->rom_spec_se_0, optarg ); break;
    case 397: settings_set_string( &settings->rom_spec_se_1, optarg ); break;
    case 398: settings_set_string( &settings->rom_speccyboot, optarg ); break;
    case 399: settings_set_string( &settings->rom_tc2048, optarg ); break;
    case 400: settings_set_string( &settings->rom_tc2068_0, optarg ); break;
    case 401: settings_set_string( &settings->rom_tc2068_1, optarg ); break;
    case 402: settings_set_string( &settings->rom_ts2068_0, optarg ); break;
    case 403: settings_set_string( &settings->rom_ts2068_1, optarg ); break;
    case 404: settings_set_string( &settings->rom_ttx2000s, optarg ); break;
    case 405: settings_set_string( &settings->rom_usource, optarg ); break;
    case 406: settings_set_string( &settings->rom_uspeech, optarg ); break;
    case 407: settings_set_string( &settings->rs232_rx, optarg ); break;
    case 408: settings_set_string( &settings->rs232_tx, optarg ); break;
    case 409: settings_set_string( &settings->sdl_fullscreen_mode, optarg ); break;
    case 410: settings_set_string( &settings->simpleide_master_file, optarg ); break;
    case 411: settings_set_string( &settings->simpleide_slave_file, optarg ); break;
    case 's': settings_set_string( &settings->snapshot, optarg ); break;
    case 413: settings_set_string( &settings->snet, optarg ); break;
    case 'd': settings_set_string( &settings->sound_device, optarg ); break;
    case 'f': settings->sound_freq = atoi( optarg ); break;
    case 414: settings_set_string( &settings->speaker_type, optarg ); break;
    case 415: settings_set_string( &settings->speccyboot_tap, optarg ); break;
    ...
    case 416: settings_set_string( &settings->stereo_ay, optarg ); break;
    case 't': settings_set_string( &settings->tape_file, optarg ); break;
    case 418: settings_set_string( &settings->teletext_addr_1, optarg ); break;
    case 419: settings_set_string( &settings->teletext_addr_2, optarg ); break;
    case 420: settings_set_string( &settings->teletext_addr_3, optarg ); break;
    case 421: settings_set_string( &settings->teletext_addr_4, optarg ); break;
    case 422: settings->teletext_port_1 = atoi( optarg ); break;
    case 423: settings->teletext_port_2 = atoi( optarg ); break;
    case 424: settings->teletext_port_3 = atoi( optarg ); break;
    case 425: settings->teletext_port_4 = atoi( optarg ); break;
    case 426: settings->volume_ay = atoi( optarg ); break;
    case 427: settings->volume_beeper = atoi( optarg ); break;
    case 428: settings->volume_covox = atoi( optarg ); break;
    case 429: settings->volume_specdrum = atoi( optarg ); break;
    case 430: settings->volume_uspeech = atoi( optarg ); break;
    case 431: settings_set_string( &settings->zxatasp_master_file, optarg ); break;
    case 432: settings_set_string( &settings->zxatasp_slave_file, optarg ); break;
    case 433: settings_set_string( &settings->zxcf_pri_file, optarg ); break;
    case 434: settings_set_string( &settings->zxmmc_file, optarg ); break;
#line 686"./settings.pl"
...
settings_copy_internal( settings_info *dest, settings_info *src )
{
  ...
  dest->composite_filter_artifacts = src->composite_filter_artifacts;
  dest->composite_filter_bleed = src->composite_filter_bleed;
  dest->composite_filter_brightness = src->composite_filter_brightness;
  dest->composite_filter_contrast = src->composite_filter_contrast;
  dest->composite_filter_fringing = src->composite_filter_fringing;
  dest->composite_filter_gamma = src->composite_filter_gamma;
  dest->composite_filter_hue = src->composite_filter_hue;
  dest->composite_filter_resolution = src->composite_filter_resolution;
  dest->composite_filter_saturation = src->composite_filter_saturation;
  dest->composite_filter_sharpness = src->composite_filter_sharpness;
...
settings_free( settings_info *settings )
{
  ...
  if( settings->rom_sp0256 ) libspectrum_free( settings->rom_sp0256 );
  ...
  if( settings->rom_uspeech ) libspectrum_free( settings->rom_uspeech );
