...
static MENU_CALLBACK( menu_options_selectroms_peripheralroms_sp0256 )
{
...
{
  menu_options_selectroms_peripheral_select( gtk_action, 13 );
}

static MENU_CALLBACK( menu_options_selectroms_peripheralroms_uspeech )
{
  menu_options_selectroms_peripheral_select( gtk_action, 14 );
}
...
GtkActionEntry gtkui_menu_data[] = {
  ...
  { "OPTIONS_PERIPHERALS_SOUND", NULL, "_Sound...", NULL, NULL, G_CALLBACK( menu_options_peripherals_sound ) },
  ...
  { "OPTIONS_SELECTROMS_PERIPHERALROMS_SP0256", NULL, "_SP0256...", NULL, NULL, G_CALLBACK( menu_options_selectroms_peripheralroms_sp0256 ) },
  ...
  { "OPTIONS_SELECTROMS_PERIPHERALROMS_USPEECH", NULL, "uS_peech...", NULL, NULL, G_CALLBACK( menu_options_selectroms_peripheralroms_uspeech ) },
  { "OPTIONS_FILTER", NULL, "_Filter...", NULL, NULL, G_CALLBACK( menu_options_filter ) },
  { "OPTIONS_FILTEROPTIONS", NULL, "_Filter options...", NULL, NULL, G_CALLBACK( menu_options_filteroptions ) },
  { "OPTIONS_FULLSCREEN", NULL, "F_ull screen", "F11", NULL, G_CALLBACK( menu_options_fullscreen ) },
