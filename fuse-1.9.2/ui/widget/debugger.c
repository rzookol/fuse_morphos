...
{
#ifdef UI_MORPHOS
  return morphosui_debugger_activate();
#else
...
{
#ifdef UI_MORPHOS
  return morphosui_debugger_deactivate( interruptible );
#else
...
{
#ifdef UI_MORPHOS
  return morphosui_debugger_disassemble( addr );
#else
...
int widget_debugger_draw( void *data GCC_UNUSED )
{
