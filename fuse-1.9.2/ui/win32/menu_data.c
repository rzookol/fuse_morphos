...
int handle_menu( DWORD cmd, HWND window )
{
  switch( cmd )
  {
    ...
    case IDM_MENU_OPTIONS_PERIPHERALS_SOUND:
      menu_options_peripherals_sound( 0 ); return 0;
    ...
    case IDM_MENU_OPTIONS_SELECTROMS_PERIPHERALROMS_SP0256:
    ...
    case IDM_MENU_OPTIONS_SELECTROMS_PERIPHERALROMS_TTX2000S:
      menu_options_selectroms_peripheral_select( 12 ); return 0;
    case IDM_MENU_OPTIONS_SELECTROMS_PERIPHERALROMS_USOURCE:
      menu_options_selectroms_peripheral_select( 13 ); return 0;
    case IDM_MENU_OPTIONS_SELECTROMS_PERIPHERALROMS_USPEECH:
      menu_options_selectroms_peripheral_select( 14 ); return 0;
    case IDM_MENU_OPTIONS_FILTER:
      menu_options_filter( 0 ); return 0;
    case IDM_MENU_OPTIONS_FILTEROPTIONS:
      menu_options_filteroptions( 0 ); return 0;
    case IDM_MENU_OPTIONS_FULLSCREEN:
      menu_options_fullscreen( 0 ); return 0;
