...
{
#ifdef __MORPHOS__
  /* The MorphOS port is a GUI application. Do not duplicate runtime
     warnings/errors into the launching shell; ui_error_specific() routes
     serious errors through MUI_Request instead. */
  (void)severity;
  (void)message;
  return 0;
#else
