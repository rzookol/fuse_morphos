...
typedef struct settings_info {
  ...
  char *betadisk_file;
   ...
   int composite_filter_artifacts;
   int composite_filter_bleed;
   int composite_filter_brightness;
   int composite_filter_contrast;
   int composite_filter_fringing;
   int composite_filter_gamma;
   int composite_filter_hue;
   int composite_filter_resolution;
   int composite_filter_saturation;
   int composite_filter_sharpness;
   int confirm_actions;
   int covox;
  char *dck_file;
